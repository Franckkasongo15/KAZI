    ...
    <div class="rounded-lg p-4 w-full sm:w-[55%] md:w-[45%] lg:w-[30%]">
        <div class="px-4">
            ...
            <form action="#" method="POST">
                <div class="mt-3">
                    <label for="name" class="block text-gray-900 dark:text-gray-50">Nom <span class="text-red-500">*</span></label>
                    <div class="mt-1">
                        <input id="name" name="name" type="name" placeholder="eddy mk" required class="block w-full rounded-lg border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 placeholder:text-sm outline-none dark:bg-gray-800 dark:focus:bg-gray-800 dark:text-gray-50 focus:ring-blue-400">
                    </div>
                </div>
