<nav class="*bg-white *dark: bg-gray-800 dark:border-gray-700" x-data="{ darkMode: localStorage.getItem('darkMode') === 'dark' || (!localStorage.getItem('darkMode') && window.matchMedia('(prefers-color-scheme: dark)').matches) }" x-init="$watch('darkMode', val => localStorage.setItem('darkMode', val ? 'dark' : 'light')); $watch('darkMode', val => document.documentElement.classList.toggle('dark', val))">
    <div class="px-4 md:px-14 lg:px-20 py-1">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <div class="flex items-center">
                    <button @click="open = !open" type="button" class="md:hidden bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500" aria-controls="mobile-menu" aria-expanded="false">
            ...
            <div class="flex items-center gap-x-2">
                <div>
                    <ul class="hidden md:flex items-center gap-x-4">
                        <li class="text-bule-400/90 transition text-blue-400"><a href="/home">Acceuil</a></li>
                        <li class="text-gray-50 transition hover:text-gray-50/85"><a href="/profile">Trouver un artisan</a></li>
                        <li class="text-gray-50 transition hover:text-gray-50/85"><a href="/settings">Tarif</a></li>
                        <li class="text-gray-50 transition hover:text-gray-50/85"><a href="/logout">Blog</a></li>
                    </ul>
                </div>
